    ...
    <div class="col-lg-2 col-md-12 browser-col-1">
        <div class="row">
            ...
            <div class="col-lg-12 col-sm-7 col-6">
                ...
                <p class="lead">Version 40+</p> 
            </div>
            <div class="col-lg-12 col-sm-2 col-3">
                <div class="frame">
                    <a href="#" type="button" class="btn btn-download btn-sm">
                        <img class="icon-text" src="assets/download.svg" alt="">
    ...
    <div class="col-lg-2 col-md-12 browser-col-2">
        <div class="row">
            <div class="col-lg-12 col-sm-3 col-3">
                <div class="frame">
                    <span class="helper"></span>
                    <img class="browser-icon" src="assets/firefox-browser.svg" alt="">

                </div>
            </div>
            <div class="col-lg-12 col-sm-7 col-6">
                <p class="lead"><b>MOZILLA FIREFOXE</b></p> 
                <p class="lead">Version 40+</p> 
            </div>
            <div class="col-lg-12 col-sm-2 col-3">
                <div class="frame">
    ...
    <div class="col-lg-2 col-md-12 browser-col-3">
        <div class="row">
            <div class="col-lg-12 col-sm-3 col-3">
                <div class="frame">
                    <span class="helper"></span>
                    <img class="browser-icon" src="assets/edge.svg" alt="">

                </div>
            </div>
            <div class="col-lg-12 col-sm-7 col-6">
                <p class="lead"><b>MICROSOFT EDGE</b></p> 
                <p class="lead">Version 40+</p> 
            </div>
            <div class="col-lg-12 col-sm-2 col-3">
                <div class="frame">
    ...
    <div class="col-lg-2 col-md-12 browser-col-4">
        <div class="row">
            <div class="col-lg-12 col-sm-3 col-3">
                <div class="frame">
                    <span class="helper"></span>
                    <img class="browser-icon" src="assets/safari.svg" alt="">

                </div>
            </div>
            <div class="col-lg-12 col-sm-7 col-6">
                <p class="lead"><b>APPLE SAFARI</b></p> 
                <p class="lead">Version 40+</p> 
            </div>
            <div class="col-lg-12 col-sm-2 col-3">
                <div class="frame">
    ...
    <div class="col-lg-2 col-md-12 browser-col-5">
        <div class="row">
            <div class="col-lg-12 col-sm-3 col-3">
                <div class="frame">
                    <span class="helper"></span>
                    <img class="browser-icon" src="assets/opera.svg" alt="">

                </div>
            </div>
            <div class="col-lg-12 col-sm-7 col-6">
                <p class="lead"><b>OPERA</b></p> 
                <p class="lead">Version 40+</p> 
            </div>
            <div class="col-lg-12 col-sm-2 col-3">
                <div class="frame">
